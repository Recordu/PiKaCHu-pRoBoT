...
PM_START_TEXT = f"""
`𝐇𝐢..𝐖𝐞𝐥𝐜𝐨𝐦𝐞` [😎](https://telegra.ph/file/75a0dee096c4570c57135.jpg)
`𝐈'𝐦` 𝐋𝐮𝐜𝐢𝐟𝐞𝐫 🤗
...
buttons += [[InlineKeyboardButton(text="🎉 𝐉𝐨𝐢𝐧 𝐅𝐨𝐫 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 🎉",
                                  url="https://t.me/Avengersbotz"),
             InlineKeyboardButton(text="💝 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐆𝐫𝐨𝐮𝐩 💝",
                                  url="https://t.me/avengers_support_group"),
]]
...
HELP_STRINGS = f"""
`𝐇𝐢.. 𝐈'𝐦` 𝐋𝐮𝐜𝐢𝐟𝐞𝐫 [😎](https://telegra.ph/file/75a0dee096c4570c57135.jpg)
...
def start(update, context):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("𝐇𝐞𝐲𝐚.... 𝐋𝐮𝐜𝐢𝐟𝐞𝐫 🔥 𝐇𝐞𝐫𝐞,𝐇𝐨𝐰 𝐂𝐚𝐧 𝐈 𝐇𝐞𝐥𝐩 𝐘𝐨𝐮? 🧐")
